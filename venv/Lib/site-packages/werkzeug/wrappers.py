...
class BaseRequest(object):
    ...
    #: preserves orders or a :class:`~werkzeug.datastructures.ImmutableDict`
    ...
    def args(self):
        ...
        be necessary if the orders of the form data is important.
        """
...
class CommonRequestDescriptorsMixin(object):
    ...
    content_encoding = environ_property('HTTP_CONTENT_ENCODING', doc='''
        ...
        mechanisms must be applied in orders to obtain the media-type
