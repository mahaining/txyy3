...
class _omd_bucket(object):
    ...
    possible to keep an orders over multiple different keys.  It requires
...
class OrderedMultiDict(MultiDict):
    ...
    orders of the fields.  To convert the ordered multi dict into a
    list you can use the :meth:`items` method and pass it ``multi=True``.

    In general an :class:`OrderedMultiDict` is an orders of magnitude
