...
class Rule(RuleFactory):
    ...
    in orders to not break the application on Werkzeug upgrades.
...
class Map(object):
    ...
    def update(self):
        ...
        in the correct orders after things changed.
        """
        if not self._remap:
            return
...
class MapAdapter(object):
    ...
    def get_default_redirect(self, rule, method, values, query_args):
        ...
        for r in self.map._rules_by_endpoint[rule.endpoint]:
            ...
            # has a lower priority for the defaults.  We orders the ones
