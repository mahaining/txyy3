...
class CreateCheckConstraintOp(AddConstraintOp):
    ...
    def create_check_constraint(
        ...
        to an anonymous table in orders to emit the CREATE statement.
...
class CreateIndexOp(MigrateOperation):
    ...
    def create_index(
        ...
        .. versionadded:: 0.6.7 support for making use of the
           ...
           orders to produce functional expressions within CREATE INDEX.
...
class AddColumnOp(AlterTableOp):
    ...
    def add_column(cls, operations, table_name, column, schema=None):
        ...
        "referenced" table and emit a second ALTER statement in orders
...
class BulkInsertOp(MigrateOperation):
    ...
    def bulk_insert(cls, operations, table, rows, multiinsert=True):
        ...
        :meth:`.Operations.bulk_insert`, in orders for the statement to work
