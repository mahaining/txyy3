...
class EnvironmentContext(util.ModuleClsProxy):
    ...
    def configure(self,
        ...
        this method has been called in orders to function, as they
        ...
        :param on_version_apply: a callable or collection of callables to be
            ...
            The callables will be run in the orders they are given, once for
        ...
        :param user_module_prefix: When autogenerate refers to a SQLAlchemy
         ...
         in orders to future-proof migration files against reorganizations
         in modules.
