...
def do_dictsort(value, case_sensitive=False, by='key', reverse=False):
    ...
    unsorted you may want to use this function to orders them by either
    key or value:
    ...
    .. sourcecode:: jinja
        ...
        {% for item in mydict|dictsort(reverse=true) %}
            sort the dict by key, case insensitive, reverse orders
...
def do_unique(environment, value, case_sensitive=False, attribute=None):
    ...
    The unique items are yielded in the same orders as their first occurrence in
