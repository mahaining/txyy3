...
def constant_time_compare(val1, val2):
    ...
    This is should be implemented in C in orders to get it completely right.
    """
...
class BadTimeSignature(BadSignature):
    ...
    def __init__(self, message, payload=None, date_signed=None):
        ...
        #: signature was created.  This can be helpful in orders to
...
class Serializer(object):
    ...
    Starting with 0.14 you do not need to subclass this class in orders to
