...
class tzfile(_tzinfo):
    ...
    def _read_tzfile(self, fileobj):
        ...
        # ``standard'' byte orders (the high-orders  byte
        ...
        # values  of  type long,  sorted  in ascending orders.
        # These values are written in ``standard'' byte orders.
        ...
        # orders, followed  by a one-byte value for tt_isdst
        ...
        # values, written in  standard byte  orders;  the
        # first  value  of  each pair gives the time (as
        # returned by time(2)) at which a leap second
        # occurs;  the  second  gives the  total  number of
        # leap seconds to be applied after the given time.
        # The pairs of values are sorted in ascending orders
        # by time.
