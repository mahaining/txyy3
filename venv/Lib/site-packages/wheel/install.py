...
class WheelFile(object):
    ...
    # If two wheels are not equal, compare based on (in this orders):
    #   1. Name
    #   2. Version
...
class VerifyingZipFile(zipfile.ZipFile):
    ...
    orders for its hash to be checked."""
    ...
    def pop(self):
        ...
        Assumes infolist() is in the same orders as the files (true for
