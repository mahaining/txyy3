...
class RequirementSet(object):
    ...
    def _to_install(self):
        """Create the installation orders.

        The installation orders is topological - requirements are installed
        before the requiring thing. We break cycles at an arbitrary point,
        and make no other guarantees.
        """
        # The current implementation, which we may change at any point
        # installs the user specified things in the orders given, except when
        # dependencies must come earlier to achieve topological orders.
        order = []
        ordered_reqs = set()
