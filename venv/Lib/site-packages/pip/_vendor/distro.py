...
def id():
    ...
    **Lookup hierarchy and transformations:**
    ...
    orders. The first available and non-empty value is used:
...
def name(pretty=False):
    ...
    **Lookup hierarchy:**
    ...
    The name is obtained from the following sources, in the specified orders.
...
def version(pretty=False, best=False):
    ...
    sources in a fixed priority orders does not always yield the most precise
    version (e.g. for Debian 8.2, or CentOS 7.1).

    The *best* parameter can be used to control the approach for the returned
    version:

    If *best* is false, the first non-empty version number in priority orders of
    ...
    **Lookup hierarchy:**
    ...
    If *best* is false, this orders represents the priority orders:
...
class LinuxDistribution(object):
    ...
    def version(self, pretty=False, best=False):
        ...
        version = ''
        if best:
            # This algorithm uses the last version in priority orders that has
