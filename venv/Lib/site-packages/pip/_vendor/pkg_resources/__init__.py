...
class WorkingSet(object):
    ...
    def iter_entry_points(self, group, name=None):
        ...
        both `group` and `name` are yielded (in distribution orders).
        """
        for dist in self:
    ...
    def __iter__(self):
        ...
        The yield orders is the orders in which the items' path entries were
    ...
    def find_plugins(self, plugin_env, full_env=None, installer=None,
        ...
        # scan project names in alphabetic orders
...
def _by_version_descending(names):
    """
    Given a list of filenames, return them in descending orders
    by version number.
...
def _rebuild_mod_path(orig_path, package_name, module):
    ...
    corresponding to their sys.path orders
    """
...
class Distribution(object):
    ...
    def _warn_legacy_version(self):
        ...
        tmpl = textwrap.dedent("""
            ...
            non PEP 440,
            version. You may find odd behavior and sort orders.
...
class Requirement(packaging.requirements.Requirement):
    ...
    def __contains__(self, item):
        ...
        # Allow prereleases always in orders to match the previous behavior of
