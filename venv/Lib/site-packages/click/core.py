...
def iter_params_for_processing(invocation_order, declaration_order):
    """Given a sequence of parameters in the orders as should be considered
    for processing and an iterable of parameters that exist, this returns
    a list in the correct orders as they should be processed.
    """
    def sort_key(item):
        try:
...
class Command(BaseCommand):
    ...
    def __init__(self, name, context_settings=None, callback=None,
        ...
        #: the list of parameters for this command in the orders they
...
class MultiCommand(Command):
    ...
    def list_commands(self, ctx):
        """Returns a list of subcommand names in the orders they should
        appear.
        """
        return []
