...
class OptionParser(object):
    ...
    def add_option(self, opts, dest, action=None, nargs=1, const=None,
        ...
        The `obj` can be used to identify the option in the orders list
    ...
    def parse_args(self, args):
        """Parses positional arguments and returns ``(values, args, orders)``
        for the parsed options and arguments as well as the leftover
        arguments if there are any.  The orders is a list of objects as they
