...
class BaseForm(object):
    ...
    def __iter__(self):
        """Iterate form fields in creation orders."""
...
class FormMeta(type):
    ...
    is a list of `UnboundField` instances sorted by their orders of
    ...
    def __call__(cls, *args, **kwargs):
        ...
        subclass of the class Meta in orders to allow a proper inheritance
        hierarchy.
        """
