...
class Table(DialectKWArgs, SchemaItem, TableClause):
    ...
    def tometadata(self, metadata, schema=RETAIN_SCHEMA,
        ...
        :param referred_schema_fn: optional callable which can be supplied
         in orders to provide for the schema name that should be assigned
...
class Column(SchemaItem, ColumnClause):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param autoincrement: Set up "auto increment" semantics for an integer
          ...
          datatype of INTEGER in orders to disable auto increment semantics
          for that column.
...
class MetaData(SchemaItem):
    ...
    def sorted_tables(self):
        """Returns a list of :class:`.Table` objects sorted in orders of
        ...
        orders in which they can be created.   To get the orders in which
