...
class TypeEngine(Visitable):
    ...
    def column_expression(self, colexpr):
        ...
        columns to be wrapped in some special database function in orders
    ...
    def bind_expression(self, bindvalue):
        ...
        in orders to coerce an application-level value into a database-specific
...
class UserDefinedType(util.with_metaclass(VisitableCheckKWArg, TypeEngine)):
    ...
    introspection is used to check for this in orders to support legacy
...
class Emulated(object):
    ...
    in orders to approximate the behavior of a database type that is provided
...
class TypeDecorator(SchemaEventTarget, TypeEngine):
    ...
    .. warning::
       ...
       be used in orders to deal with operators like index operations::
