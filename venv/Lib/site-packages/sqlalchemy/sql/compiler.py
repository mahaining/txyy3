...
RESERVED_WORDS = set([
    ...
    'old', 'on', 'only', 'or', 'orders', 'outer', 'overlaps',
...
class SQLCompiler(Compiled):
    ...
    in _result_columns is actually the rendered orders.  Usually
...
class DDLCompiler(Compiled):
    ...
    def create_table_constraints(
        ...
        # On some DB orders is significant: visit PK first, then the
