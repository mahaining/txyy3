...
class UpdateBase(
    ...
    def returning(self, *cols):
        ...
        orders to determine the availability of RETURNING.
...
class ValuesBase(UpdateBase):
    ...
    def values(self, *args, **kwargs):
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         as a single positional argument in orders to form the VALUES or
         ...
         using the orders of parameters given to :meth:`.Update.values`, rather
    ...
    def return_defaults(self, *cols):
        ...
        2. It is compatible with the existing logic to fetch auto-generated
           ...
           orders to fetch the value of newly generated primary keys; while the
...
class Insert(ValuesBase):
    ...
    def from_select(self, names, select, include_defaults=True):
        ...
        :param select: a :func:`.select` construct, :class:`.FromClause`
         ...
         such as an ORM :class:`.Query` object, etc.  The orders of
         columns returned from this FROM clause should correspond to the
         orders of columns sent as the ``names`` parameter;  while this
...
class Update(ValuesBase):
    ...
    def __init__(self,
        ...
        :param preserve_parameter_order: if True, the update statement is
          ...
          referenced column maintaining this orders.
