...
class ClauseElement(Visitable):
    ...
    def get_children(self, **kwargs):
        ...
        returned, for example to return a subset of items in orders to
...
class BindParameter(ColumnElement):
    ...
    def __init__(self, key, value=NO_ARG, type_=None,
        ...
        In orders to populate the value of ``:username`` above, the value
...
class BooleanClauseList(ClauseList, ColumnElement):
    ...
    def and_(cls, *clauses):
        ...
        need to be parenthesized in orders to function with Python
...
class TypeCoerce(ColumnElement):
    ...
    def __init__(self, expression, type_):
        ...
        type-coerced or direct values of the target column.  In orders to
...
class quoted_name(util.MemoizedSlots, util.text_type):
    ...
    for this identifier in orders to either unconditionally quote
...
class conv(_truncated_label):
    ...
    converted.  In orders to make sure the name isn't double-modified, the
