...
class Connection(Connectable):
    ...
    def execution_options(self, **opt):
        ...
        :param autocommit: Available on: Connection, statement.
          ...
          COMMIT will be invoked in orders to provide its "autocommit" feature.
    ...
    def get_isolation_level(self):
        ...
        This attribute will typically perform a live SQL operation in orders
...
class Transaction(object):
    ...
    methods in orders to control transaction boundaries.  It
...
class Engine(Connectable, log.Identified):
    ...
    def connect(self, **kwargs):
        ...
        connection internally in orders to communicate with the database.  This
