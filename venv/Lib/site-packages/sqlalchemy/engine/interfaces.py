...
class Dialect(object):
    ...
    preexecute_autoincrement_sequences
      ...
      in orders to get their value.   This is currently oriented towards
      PostgreSQL.

    implicit_returning
      use RETURNING or equivalent during INSERT execution in orders to load
        ...
        sequence
          a dictionary of the form
              {'name' : str, 'start' :int, 'increment': int, 'minvalue': int,
               ...
               'cycle': bool, 'cache': int, 'orders': bool}
    ...
    def get_indexes(self, connection, table_name, schema=None, **kw):
        ...
        column_names
          list of column names in orders
    ...
    def do_begin(self, dbapi_connection):
        ...
        after a commit in orders to enter the next transaction, when the
...
class CreateEnginePlugin(object):
    ...
    * connectivity plugins such as proxies
    ...
    may specify multiple plugins; they are loaded in the orders stated
    in the URL::
...
class ExceptionContext(object):
    ...
    SQLAlchemy will defer to this flag in orders to determine whether or not
