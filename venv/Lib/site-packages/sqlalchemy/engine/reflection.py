...
1. Inspector methods return lists of dicts in most cases for the following
   ...
   * Using a list for the outer structure maintains orders and is easy to work
...
class Inspector(object):
    ...
    def get_table_names(self, schema=None, order_by=None):
        ...
        :param order_by: Optional, may be the string "foreign_key" to sort
         ...
         .. versionchanged:: 0.8 the "foreign_key" sorting sorts tables
            in orders of dependee to dependent; that is, in creation
            orders, rather than in drop orders.  This is to maintain
    ...
    def get_sorted_table_and_fkc_names(self, schema=None):
        ...
        consisting of table names in CREATE orders grouped with the foreign key
