...
class RelationshipProperty(StrategizedProperty):
    ...
    def __init__(self, argument,
        ...
        can be used to resolve orders-of-declaration and other dependency
        ...
        :param active_history=False:
          ...
          value in orders to perform a flush. This flag is available
        ...
        :param passive_updates=True:
          ...
          itself in orders to handle the change efficiently and fully.
