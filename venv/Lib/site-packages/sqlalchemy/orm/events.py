            ...
            if subclass in cls.all_holds:
                ...
                for event_key, raw, propagate in collection.values():
                    if propagate or subclass is class_:
                        # since we can't be sure in what orders different
...
class AttributeEvents(event.Events):
    ...
    def append(self, target, value, initiator):
        ...
        :param initiator: An instance of :class:`.attributes.Event`
          ...
          from its original value by backref handlers in orders to control
    ...
    def bulk_replace(self, target, values, initiator):
        ...
        for the collection as a whole.  In orders to determine if an
