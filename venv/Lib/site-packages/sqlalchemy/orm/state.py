...
class InstanceState(interfaces.InspectionAttr):
    ...
    SQLAlchemy ORM in orders to track the state of an object;
    ...
    in orders to acquire a :class:`.InstanceState` object
    ...
    def deleted(self):
        ...
        .. note::
            ...
            True**; in orders to detect that a state was deleted, regardless
