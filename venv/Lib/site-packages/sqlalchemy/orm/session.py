...
class Session(_SessionClassMethods):
    ...
    def __init__(self, bind=None, autoflush=True, expire_on_commit=True,
        ...
        :param autoflush: When ``True``, all query operations will issue a
           ...
           not be called repeatedly in orders for database queries to retrieve
        ...
        :param binds: An optional dictionary which contains more granular
           ...
           well as the mapper's ``mapped_table`` attribute in orders to locate
    ...
    def begin_nested(self):
        ...
        .. seealso::
            ...
            with the SQLite driver in orders for SAVEPOINT to work
            correctly.
    ...
    def execute(self, clause, params=None, mapper=None, bind=None, **kw):
        ...
        a rule-based resolution scheme in orders to determine the
        ...
        .. seealso::
            ...
            in orders to execute the statement.
    ...
    def expire_all(self):
        ...
        :class:`.Session` object's current transactional context in orders to
    ...
    def is_active(self):
        ...
        call :meth:`.Session.rollback`, in orders to close out the
...
class sessionmaker(_SessionClassMethods):
    ...
    def __init__(self, bind=None, class_=Session, autoflush=True,
        ...
        :param class_: class to use in orders to create new :class:`.Session`
