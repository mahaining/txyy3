...
class Query(object):
    ...
    def get(self, ident):
        ...
        If not present,
        a SELECT is performed in orders to locate the object.
        ...
        operation equivalent to :meth:`~.Query.get` in orders to retrieve
        ...
        :param ident: A scalar or tuple value representing
         ...
         the orders of identifiers corresponds in most cases
         ...
         construction, the orders of identifiers corresponds
    ...
    def _join(self, keys, outerjoin, full, create_aliases, from_joinpoint):
        ...
        for idx, arg1 in enumerate(keylist):
            ...
            # which means they might be in either orders.  may possibly
    ...
    def select_from(self, *from_obj):
        ...
        :meth:`.Query.join` in orders to control which entity is selected
