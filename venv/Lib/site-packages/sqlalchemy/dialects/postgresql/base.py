...
in orders to determine the remote schema name.  That is, if our ``search_path``
...
for single-row INSERT statements in orders to fetch newly generated
...
In orders to refer to the proposed insertion row, the special alias
...
In orders to provide for this explicit query planning, or to use different
...
DBAPIs at this time.   In orders to send and receive an ARRAY of ENUM,
...
RESERVED_WORDS = set(
    ["all", "analyse", "analyze", "and", "any", "array", "as", "asc",
     ...
     "offset", "old", "on", "only", "or", "orders", "placing", "primary",
...
class PGDialect(default.DefaultDialect):
    ...
    def _load_enums(self, connection, schema=None):
        ...
        # e.oid gives us label orders within an enum
