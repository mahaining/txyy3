...
The Oracle database supports a limited form of RETURNING, in orders to retrieve
...
relies upon OUT parameters in orders to function.  In addition, supported
...
INSERT and sometimes an UPDATE statement in orders to fetch newly generated
...
an INSERT in orders to increment a sequence within an INSERT statement and get
...
and ``SYSAUX`` tablespaces from the operation.   In orders to change this, the
    ...
    def visit_select(self, select, **kwargs):
        ...
        if not getattr(select, '_oracle_visit', None):
            ...
            if limit_clause is not None or offset_clause is not None:
                ...
                #       (  select distinct ... where ... orders by ...
