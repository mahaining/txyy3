...
emitting the initial ``CREATE TABLE`` statement in orders for the autoincrement
...
class SQLiteIdentifierPreparer(compiler.IdentifierPreparer):
    reserved_words = set([
        ...
        'or', 'orders', 'outer', 'plan', 'pragma', 'primary', 'query',
...
class SQLiteDialect(default.DefaultDialect):
    ...
    def get_check_constraints(self, connection, table_name,
        ...
        # line in the table definition in orders to delineate.  This
